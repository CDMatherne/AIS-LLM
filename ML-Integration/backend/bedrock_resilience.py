...
class BedrockResilienceLayer:
    ...
    def __init__(self, 
        ...
        self.model_mapping = {
            "anthropic.claude-3-7-sonnet-20250219-v1:0": "claude-3-5-sonnet-20241022",  # Updated
    ...
    def _translate_bedrock_to_anthropic_model(self, bedrock_model: str) -> str:
        ...
        """
        return self.model_mapping.get(bedrock_model, "claude-3-5-sonnet-20241022")  # Default fallback (updated)
